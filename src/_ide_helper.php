...
namespace Illuminate\Support {
     ...
     */        class Collection {
         ...
         * @return \Illuminate\Support\Collection 
         * @static 
         */        public static function recursiveCollect()
        {
                        return \Illuminate\Support\Collection::recursiveCollect();
        }
                    /**
         * 
         *
         ...
         * @param string $key
         * @static 
         */        public static function getDot($key)
        {
                        return \Illuminate\Support\Collection::getDot($key);
        }
                    /**
         * 
         *
         ...
         * @param string $key
         * @static 
         */        public static function getDotRaw($key)
        {
                        return \Illuminate\Support\Collection::getDotRaw($key);
        }
                    /**
         * 
         *
