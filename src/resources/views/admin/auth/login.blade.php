<x-guest-layout>
    ...
    <div class="min-w-[300px] min-h-[200px] flex flex-col">
        <div class="w-full mb-3 h-fit">
            <p class="p-1 text-xl text-white">Admin Login</p>
        </div>

        <!-- Sign in section -->
        <div class="flex items-center justify-center flex-1 w-full0">
            <!-- Google login -->
            <a class="flex items-center justify-center w-full py-2 space-x-2 border border-gray-600 rounded-md h-fit hover:bg-gray-700"
                href="{{ route('oauth.admin.login') }}">
